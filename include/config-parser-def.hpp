...
/*   Updated: 2026/05/22 23:35:02 by nlaporte         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define KEYWORDS                                                                                             \
    ...
    X(OPEN_SCOPE, "{", 1, " ", 0, 0, 0, string_check, std::string)                                                        \
    X(CLOSE_SCOPE, "}", 1, " ", 0, 0, 0, string_check, std::string)                                                       \
    ...
    X(UNKNOWN, " ", 1, "https://nginx.org/en/docs/http/ngx_http_core_module.html", 0, 0, 0, string_check, std::string)                                                          \
...
enum type {
#define X(name, _, __, ___, ____, _____, ______, _______, _________) name,
    KEYWORDS
#undef X
};
}
